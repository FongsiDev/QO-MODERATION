module.exports = {
  embedded: async (message, channel, options = {}) => {
    let conf = false;
    let but = new global.MessageActionRow().addComponents(
      new global.MessageButton()
        .setStyle("SUCCESS")
        .setLabel("Create")
        .setEmoji("954526726698987581")
        .setCustomId("embc"),
      new global.MessageButton()
        .setStyle("DANGER")
        .setLabel("Cancel")
        .setEmoji("954528313517428757")
        .setCustomId("embd")
    );

    let result = new global.MessageEmbed().setColor("#2F3136");
    let opt = new global.MessageActionRow().addComponents(
