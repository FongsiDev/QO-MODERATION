module.exports = new global.builder()
  .setName("react")
  .setDescription("Reaction Command Like NQN")
  .setBotPerms(["ADD_REACTIONS", "MANAGE_MESSAGES", "MANAGE_EMOJIS"])
  .setArgs(true)
  .setUsage("react <message to how much> <:emoji: :emoji: ...>")
  .setCategory("Misc")
  .setRun(async (client, message, args) => {
    ...
    try {
      ...
      const emojis =
        get[_0xfadb43(0x1fc)]("\x20")[_0xfadb43(0x1e3)](
          /(?<=:)([^:\s]+)(?=:)/g
        );
      if (!emojis) return;
      emojis[_0xfadb43(0x1e7)](async (_0x5d9106) => {
        ...
        if (get_msg && !isNaN(get_msg)) {
          ...
          _0x14f7d4["on"](_0x59a5e0(0x1fd), async (_0xad7151, _0x355da1) => {
            ...
            _0xad7151["users"][_0x1b5284(0x1e8)](
              client[_0x1b5284(0x1f5)]["id"]
            );
          });
        } else {
          message[_0x59a5e0(0x1e2)]["messages"]
